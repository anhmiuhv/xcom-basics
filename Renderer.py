        ...
        for j in range(0,self.board.height):
            for i in range(0,self.board.width):
                ...
                if (self.board.tiles[i][j].coverN != 0):
                    pygame.draw.line(blank, (50,140,200,self.board.tiles[i][j].coverN), (0,0), (res,0), 4)

                if (self.board.tiles[i][j].coverS != 0):
                    pygame.draw.line(blank, (50,140,200,self.board.tiles[i][j].coverS), (0,res+2), (res,res+2), 4)

                if (self.board.tiles[i][j].coverW != 0):
                    pygame.draw.line(blank, (50,140,200,self.board.tiles[i][j].coverW), (0,0), (0,res+2), 4)

                if (self.board.tiles[i][j].coverE != 0):
                    pygame.draw.line(blank, (50,140,200,self.board.tiles[i][j].coverE), (res+2,0), (res+2,res), 4)
